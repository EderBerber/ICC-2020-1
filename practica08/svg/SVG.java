...
public class SVG {
    ...
    public void agregarLinea(Linea linea) {
        // Implementar
        String s = "<line x1= \""+linea.getP1().getX()+"\" y1= \""+(altura-linea.getP1().getY())+"\" x2= \""+linea.getP2().getX()+"\" y2= \""
        +(altura-linea.getP2().getY())+"\" style=\"stroke:black; stroke-width: 1\" />";
        concatenar(s);
    }
    ...
    public void agregarTriangulo(Triangulo triangulo) {
        // Implementar
        Linea ab = new Linea (triangulo.getPunto1(),triangulo.getPunto2());
        Linea bc = new Linea (triangulo.getPunto2(),triangulo.getPunto3());
        Linea ca = new Linea (triangulo.getPunto3(),triangulo.getPunto1());
